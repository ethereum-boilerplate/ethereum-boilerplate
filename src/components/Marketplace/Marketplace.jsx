...
import { paddingLRContent, BtnPrimary, BtnInfo, pageTitleStyle } from "../../GlobalStyles";
  ...
  return (
    <div style={{
      ...
      <section style={{
        ...
        <p>GymBuddies are now in <b>mint mode</b> 💪</p>
        ...
        <div>
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                `https://docs.metagymland.com/marketplace`,
                "_blank"
              )
            }
          >
