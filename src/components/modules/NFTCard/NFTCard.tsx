...
const NFTCard: FC<INFTCard> = ({ amount, contractType, name, symbol, tokenAddress, tokenId, metadata }) => {
    ...
    return (
        <Box bgColor={bgColor} padding={3} borderRadius="xl" borderWidth="1px" borderColor={borderColor}>
            <Box maxHeight="260px" overflow={'hidden'}>
                <Image src={metadata?.image as string} alt={'nft'} minH="260px" boxSize="100%" objectFit="fill" borderRadius="xl" />
            </Box>
