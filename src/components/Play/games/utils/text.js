...
export const createTextBox = function (scene, x, y, config, bg = COLOR_PRIMARY,
    stroke = COLOR_LIGHT, align = "center", txtColor = "white") {
    ...
    const tBoxCfg = {
        ...
        text: getBBcodeText(scene, wrapWidth, fixedWidth, fixedHeight, align, txtColor),
        // draggable: true,
        space: {
            left: 10,
            right: 10,
...
const getBBcodeText = function (scene, wrapWidth, fixedWidth, fixedHeight, align, txtColor) {
    const bbTextCfg = {
