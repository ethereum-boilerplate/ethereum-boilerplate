...
export const useVerifyMetadata = () => {
  ...
  function resolveCommonMetadata(NFT, metadata) {
    ...
    if (metadata?.snap_ar_link) NFT.snap_ar_link = metadata.snap_ar_link;
    if (metadata?.snap_ar_miniature_link)
      NFT.snap_ar_miniature_link = metadata.snap_ar_miniature_link;
  }
