  ...
  return (
    <div style={{ display: "flex", gap: "10px" }}>
      <Card
        ...
        title={
          <>
            📝 <Text className="card-title" strong>To-Do List</Text>
          </>
        }
      >
      ...
      <div>
        <Card
          ...
          title={
            <>
              💣 <Text className="card-title" strong>Starting Local Chain (optional)</Text>
            </>
          }
        >
          <Timeline mode="left" style={styles.timeline}>
        ...
        <Card
          ...
          title={
            <>
              📡 <Text className="card-title" strong> Connecting your Local Chain to the Moralis DB</Text>
            </>
          }
        >
          <Timeline mode="left" style={styles.timeline}>
